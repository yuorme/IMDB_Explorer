...
Returns a searchable and sortable table that is reactively subsetted using the `shiny::renderDataTable` function. This function makes use of the Javascript library DataTables to generate the output. 